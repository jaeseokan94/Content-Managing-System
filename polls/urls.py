...
urlpatterns = [
    ...
    url(r'^api/(?P<language>[a-zA-Z0-9]+)/(?P<level>[a-zA-Z0-9]+)/(?P<topic_name>[\w\s]+)/(?P<subtopic_name>[\w\s]+)/(?P<exercise_id>[0-9]+)/vocabExercisesQuestions/$', views.exercise_vocab_question_list()),
