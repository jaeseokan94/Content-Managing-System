...
urlpatterns = [
    ...
    url(r'^(?P<language_name>[\w]+)/glossary/edit/$', views.glossary_update, name="glossary_update"),
    ...
    url(r'^(?P<language_name>[\w]+)/(?P<level>[\w]+)/(?P<topic_name>[\w\s]+)/(?P<subtopic_name>[\w\s]+)/editVocab/$', views.subtopic_vocabulary_update, name='subtopic_vocabulary_update'),
    ...
    url(r'^(?P<language_name>[\w]+)/(?P<level>[\w]+)/(?P<topic_name>[\w\s]+)/(?P<subtopic_name>[\w\s]+)/(?P<exercise_id>[0-9]+)/(?P<question_id>[0-9]+)/delete/$', views.exercise_question_delete, name='exercise_question_delete'),
