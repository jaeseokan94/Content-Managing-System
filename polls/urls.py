...
urlpatterns = [
    ...
    url(r'^(?P<language_name>[\w]+)/(?P<level>[\w]+)/(?P<topic_name>[\w\s]+)/(?P<subtopic_name>[\w\s]+)/(?P<exercise_name>[\w\s]+)/exerciseQuestion/$', views.exercise_question_detail, name='exercise_question_detail'),
    url(r'^(?P<language_name>[\w]+)/(?P<level>[\w]+)/(?P<topic_name>[\w\s]+)/(?P<subtopic_name>[\w\s]+)/exerciseQuestion/edit/$', views.exercise_question_update, name='exercise_question_update'),
