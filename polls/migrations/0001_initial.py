# -*- coding: utf-8 -*-
# Generated by Django 1.9.3 on 2016-03-24 19:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_text', models.CharField(max_length=200)),
                ('choice_1', models.ImageField(blank=True, default='', null=True, upload_to='vocabulary/pictures', validators=[polls.models.validate_picture_extension])),
                ('choice_2', models.ImageField(blank=True, default='', null=True, upload_to='vocabulary/pictures', validators=[polls.models.validate_picture_extension])),
                ('choice_3', models.ImageField(blank=True, default='', null=True, upload_to='vocabulary/pictures', validators=[polls.models.validate_picture_extension])),
                ('choice_4', models.ImageField(blank=True, default='', null=True, upload_to='vocabulary/pictures', validators=[polls.models.validate_picture_extension])),
                ('choice_5', models.ImageField(blank=True, default='', null=True, upload_to='vocabulary/pictures', validators=[polls.models.validate_picture_extension])),
                ('choice_6', models.ImageField(blank=True, default='', null=True, upload_to='vocabulary/pictures', validators=[polls.models.validate_picture_extension])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture_url', models.ImageField(blank=True, null=True, upload_to='picture resources', validators=[polls.models.validate_picture_extension])),
                ('audio_url', models.FileField(blank=True, null=True, upload_to='audio resources', validators=[polls.models.validate_audio_extension])),
                ('resource_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.Resource')),
            ],
        ),
